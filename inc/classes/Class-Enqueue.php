 ...
 */
	...
	class zeus_Enqueue{
		...
		public function zeus_scripts_enqueue_init(){
			add_action( 'wp_enqueue_scripts', array( $this, 'zeus_frontend_enqueue_scripts', ) );
		}

		public function zeus_frontend_enqueue_scripts( ){
