...
// image default alt
if ( ! function_exists( 'zeus_img_default_alt' ) ) {
	function zeus_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'zeus_img_tag' ) ) {
	function zeus_img_tag( array $args ) {
...
// Anchor Tag
if ( ! function_exists( 'zeus_anchor_tag' ) ) {
	function zeus_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'zeus_heading_tag' ) ) {
	function zeus_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'zeus_paragraph_tag' ) ) {
	function zeus_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'zeus_other_tag' ) ) {
	function zeus_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'zeus_button_element ' ) ) {
	function zeus_button_element( array $args ) {
